...
/**
 * Minimal `asChild` merge (Base UI, which this project uses instead of Radix,
 * has no standalone Slot primitive). Only handles a single child, which is
 * all every call site below needs.
 */
function Slot({
  children,
  ...slotProps
...
interface GetItemValue<T> {
  /** Returns a unique identifier for each sortable item. Required for an array of objects. */
  getItemValue: (item: T) => UniqueIdentifier
}
